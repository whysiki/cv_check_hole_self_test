...
def process_images(images: str, auto_threshold: bool = False) -> None:
    ...
    with concurrent.futures.ProcessPoolExecutor(
        ...
        futures = {
            executor.submit(
                single_image_processing, image_path, False, 128, auto_threshold
            )
...
if __name__ == "__main__":
    ...
    process_images(r"样本图像（正常及缺陷）\缺陷样本", auto_threshold=True)
